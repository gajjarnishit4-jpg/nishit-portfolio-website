...
import { platformProjects } from "@/tenants/fullstack/lib/project-showcase";
...
const platforms = [
  {
    name: "Shopify",
    category: "Commerce",
    icon: "/tenant-assets/fullstack/brands/shopify.svg",
  ...
  },
  {
    ...
    icon: "/tenant-assets/fullstack/brands/wordpress.svg",
      ...
      <div className="content-width">
        ...
        <div className="platform-selector" role="tablist" aria-label="Website platform" onKeyDown={tabKeys} style={{ "--selected-platform": active } as CSSProperties}>
          {platforms.map((platform, index) => (
            ...
            >
              <Image unoptimized src={platform.icon} alt="" width={30} height={30} />
        ...
        <div className="platform-showcase-body">
          ...
          >
            <div className="platform-gallery-label"><span>FROM NISHIT&apos;S PORTFOLIO</span><span>Websites & commerce</span></div>
            <div
